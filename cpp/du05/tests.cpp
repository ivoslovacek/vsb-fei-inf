...
TEST_SUITE("UTF8String old")
{
    ...
    TEST_CASE("Non-empty string can be assigned")
    {
        ...
        UTF8String str2{std::vector<CodePoint>{0x1F614, 0x010D, static_cast<CodePoint>('f')}};
        str2.append('a');
    ...
    {
        UTF8String s1{std::vector<CodePoint>{
            0x1F601, // 😁
            0x1F614, // 😔
            static_cast<CodePoint>('0'),
            0x010D // č
        ...
        UTF8String s2{std::vector<CodePoint>{
            0x1F602, // succ 😁
            0x1F614, // 😔
            static_cast<CodePoint>('0'),
            0x010D // č
    ...
    {
        UTF8String str{"Hello"};
        UTF8String str2{std::vector<CodePoint>{0x20AC, // €
...
template <typename Item, typename Iterator> std::vector<Item> collect(Iterator iterator)
{
...
template <typename T> void check_vectors(std::vector<T> a, std::vector<T> b)
{
...
TEST_SUITE("UTF8String new")
{
    ...
    TEST_CASE("Iterate bytes")
    {
        ...
        check_vectors(collect<uint8_t>(str.bytes()),
                      std::vector<uint8_t>{0xF0, 0x9F, 0x98, 0x81, 0xF0, 0x9F, 0x98, 0x94, 0x30, 0xC4, 0x8D});
    }
    ...
    {
        std::vector<uint8_t> utf8input{0xF0, 0x9F, 0x98, 0x81, 0xF0, 0x9F, 0x98, 0x94, 0x30, 0xC4, 0x8D};
