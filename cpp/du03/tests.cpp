...
auto parse_digit = any_of(std::vector<Parser>{create_char_parser('0'), create_char_parser('1'), create_char_parser('2'),
                                              create_char_parser('3'), create_char_parser('4'), create_char_parser('5'),
                                              create_char_parser('6'), create_char_parser('7'), create_char_parser('8'),
...
{
    auto parser1 = any_of(std::vector<Parser>{parse_digit, create_char_parser('x'), create_word_parser("foo")});
    ...
    auto parser2 = any_of(std::vector<Parser>{create_word_parser("abc"), skip_ws()});
...
{
    auto parser1 =
        sequence(std::vector<Parser>{parse_digit, create_char_parser('x'), parse_digit, create_word_parser("end")});
    ...
    auto parser3 = sequence(std::vector<Parser>{create_word_parser("vsb"), skip_ws(), create_char_parser('-'),
                                                skip_ws(), create_word_parser("tuo")});
