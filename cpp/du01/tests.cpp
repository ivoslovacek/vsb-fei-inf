...
TEST_SUITE("Camel to snake conversion")
{
    ...
    TEST_CASE("Long word")
    {
        REQUIRE(strutils::camel_to_snake("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA") ==
                "a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a");
    }
}
...
TEST_SUITE("UTF-8 validation")
{
    ...
    TEST_CASE("Simple")
    {
        std::vector<uint8_t> input{0b01100001, 0b01101000, 0b01101111, 0b01101010};
        size_t result = std::numeric_limits<size_t>::max();
        REQUIRE(strutils::validate_utf8(input, result));
        REQUIRE(result == 4);
    }
    ...
    {
        std::vector<uint8_t> input{0b01001100, 0b11000011, 0b10101101, 0b01100010, 0b11000011, 0b10101101,
                                   0b00100000, 0b01110011, 0b01100101, 0b00100000, 0b01110100, 0b01101001,
                                   0b00100000, 0b01000011, 0b00101011, 0b00101011, 0b00111111, 0b00100000,
