...
TEST_SUITE("Object")
{
    TEST_CASE("Create object")
    {
        ...
        const Object object{{{"a", value}, {"b", new Integer{2}}, {"c", new Null{}}}};
...
TEST_SUITE("Clone")
{
    ...
    TEST_CASE("Array")
    {
        ...
        auto *value = new Array{
            {new Integer{1}, new Integer{1}, new Array{{new Integer{10}, new Integer{11}}}, new Integer{4}, obj}};
...
TEST_SUITE("Print")
{
    ...
    TEST_CASE("Array")
    {
        auto *obj = new Object{{{"a", new Integer{5}}, {"b", new Array{{new Integer{1}, new Integer{2}}}}}};
        const Array value{{
            new Integer{1},
            new Integer{2},
            obj,
    ...
    TEST_CASE("Object")
    {
        ...
        const Object value{{
            ...
            {"c", array},
            {"d", new Object{{{"a", new Integer{5}}, {"b", new Integer{6}}}}},
            {"e", new Null()},
        }};
